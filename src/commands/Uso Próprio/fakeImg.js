  ...
  handle: async ({
    ...
    try {
      ...
      */
      ...
      // Por enquanto você só pode alterar a imagem fake padrão usando o comando "mek" em alguma imagem, copiando o jpegThumbnail e colando no lugar desse aí de baixo :p
