...
import { type LoggingsPluginData, type LoggingsPluginLoader } from "./plugin.ts";
/**
 * Loggings Core Class
 *
 * @class LoggingsCORE
 ...
 */
export declare class LoggingsCORE<LoggingsConfig extends LoggingsPluginData<object>> {
    /**
