    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                console.log("media.key.id", media.key.id)
                console.log("options.useCachedGroupMetadata", options.useCachedGroupMetadata)
                console.log("additionalAttributes", additionalAttributes)
                console.log("options.statusJidList", options.statusJidList)
                console.log("options.additionalNodes", options.additionalNodes)
                console.log("options.ai", options.ai)
